...
```powershell
powershell -ExecutionPolicy Bypass -Command "Invoke-Expression (Invoke-RestMethod 'https://raw.githubusercontent.com/MeowTonynohhh/MeowModAnalyzer/main/MeowModAnalyzer.ps1')"
```
...
Discord: `tonyboy90_`
GitHub: [MeowTonynohhh](https://github.com/MeowTonynohhh)
YouTube: `tonynoh-07`
